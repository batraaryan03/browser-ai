  ...
  return (
    <div className="relative min-h-dvh flex flex-col bg-[var(--bg)]">
      ...
      <main className="flex-1 flex flex-col items-center px-5 pt-8 pb-20">
        {/* Page header */}
        <div className="text-center space-y-2 mb-6 max-w-lg">
          <h1 className="text-2xl font-medium tracking-tight">PDF Summarization</h1>
          <p className="text-sm text-gray-400">
            Drag a PDF or paste text. AI summarizes it entirely on your device — no uploads, no servers.
          </p>
        </div>
