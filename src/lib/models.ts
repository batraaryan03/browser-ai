...
const MODELS: ModelInfo[] = [
  ...
  // ── Chat ───────────────────────────────────────────────────────────
  {
    ...
    description:
      "Chat with your fine-tuned personality model entirely in the browser. Upload your ONNX model ZIP and chat without any server. Powered by ONNX Runtime Web + WebGPU — all inference runs on your device.",
    category: "text",
    repo: "",
    sizeBytes: 0,
    task: "chat",
